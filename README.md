...
3. **Ingress** – Exposes the application via an HTTP endpoint. Use **round_robin** for the load balancing and healthcheck to check to which pods to direct th requests.
